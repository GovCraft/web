...
export default async function PrivacyPolicy() {
    return (
        <>
            <PageIntro eyebrow="We respect your data" title="Privacy Policy">
                {/* <p>
            ...
            <Container>
                ...
                <div className="mt-10 max-w-2xl space-y-6 text-base">
                    ...
                    <h1>This Privacy Notice was last modified on January 29, 2024.</h1>

                    <p>Govcraft (&quot;us&quot;, &quot;we&quot;, or &quot;our&quot;) operates www.govcraft.ai
                        (the “SERVICE”).</p>
                    ...
                    <ul>
                        ...
                        <li>Ensure access to your data is safe and secure</li>
                        <li>Process payments</li>
                        <li>Direct your enquiries to the appropriate customer support staff</li>
                        <li>Investigate and address your concerns</li>
                        <li>Communicate with you about products, services, promotions, studies, surveys, news and updates relating to our service</li>
                        <li>Process promotions/competitions, including prizes, and send you information about our services</li>
                        <li>Investigate or address legal proceedings relating to your use of our services/products, or as otherwise allowed by applicable law</li>
                    </ul>
                    ...
                    <ul>
                        ...
                        <li>Our legal advisors in the event of a dispute or other legal matter</li>
                        <li>Law enforcement officials, government authorities, or other third parties to meet our legal obligations</li>
                    ...
                    <ul>
                        ...
                        <li>There are overriding legitimate business interests, including but not limited to fraud prevention and protecting customers&quot; safety and security</li>
                    </ul>
                    ...
                    <p>You may request access to, correction of, or a copy of your information
                        by contacting us at privacy@govcraft.ai</p>
